...
{
  bool assoc;                        /**< 已关联（由非零 STA IP 推断） */
  bool has_ip;                       /**< STA IPv4 可用 */
...
/**
  ...
  * @retval false  空闲（或未开 VG_NET_FAILOVER / ESP8266）。
  */
...
/**
  ...
  * @note   与 RJ45 健康无关；TCP 仍仅在活动出口为 wifi 时使用 lesp。
  * @retval 负值  失败。
  * @retval 0     成功。
  */
